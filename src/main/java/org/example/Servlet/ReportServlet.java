...
public class ReportServlet extends HttpServlet {
    ...
    private JSONObject handleDailySalesReport(HttpServletRequest req) throws SQLException, ClassNotFoundException {
        ...
        String query = "SELECT b.id, b.invoiceNumber, b.fullPrice, b.discount, b.cashTendered, " +
                      "b.changeAmount, b.billDate, b.transactionType, b.storeType, " +
    ...
    private JSONObject handleItemsNeedShelvingReport(HttpServletRequest req) throws SQLException, ClassNotFoundException {
        JSONObject result = new JSONObject();
        JSONArray data = new JSONArray();
    ...
    private JSONObject handleReorderLevelReport(HttpServletRequest req) throws SQLException, ClassNotFoundException {
        ...
        // Use fixed reorder level of 50 (hardcoded business rule: if total stock < 50, reorder needed)
        String query = """
    ...
    private JSONObject handleCombinedTransactionReport(HttpServletRequest req) throws SQLException, ClassNotFoundException {
        String date = req.getParameter("date");
