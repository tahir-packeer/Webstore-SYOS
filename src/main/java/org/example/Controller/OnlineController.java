...
public class OnlineController {
    ...
    public boolean registerOnlineCustomer(Customer customer, String email, String address) throws SQLException, ClassNotFoundException {
        ...
        String query = "INSERT INTO online_customers (name, contactNumber, email, address, registrationDate) VALUES (?, ?, ?, ?, ?)";
