...
public class Admin {
    ...
    private void generateReportsByTransactionType(User user) {
        ...
        ReportController reportController = new ReportController();
        try {
            System.out.println("\n=== Sales Report by Transaction Type ===");
            reportController.generate_sales_report(date, transactionType, null);
            
            System.out.println("\n=== Bill Transaction Report by Transaction Type ===");
    ...
    private void generateReportsByStoreType(User user) {
        ...
        ReportController reportController = new ReportController();
        try {
            System.out.println("\n=== Sales Report by Store Type ===");
            reportController.generate_sales_report(date, null, storeType);
            
            System.out.println("\n=== Bill Transaction Report by Store Type ===");
