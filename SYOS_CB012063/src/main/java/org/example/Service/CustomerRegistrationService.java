...
public class CustomerRegistrationService {
    ...
    public int registerCustomer(String name, String contactNumber) {
        ...
        String sql = "INSERT INTO customer (name, contact_number, customer_type, registration_date) VALUES (?, ?, 'REGULAR', NOW())";
    ...
    private boolean isPhoneNumberExists(String contactNumber) {
        String sql = "SELECT COUNT(*) FROM customer WHERE contact_number = ?";
